    ...
    <div class="col-md-10 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                $dataP = $reqP -> fetch();
                ?>
                <form class="forms-sample" method="POST" action="traitements/traitement-modif-produits.php">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-secondary" id="descriptions" name="descriptions" rows="2"><?php echo $dataP['descriptions'] ;?></textarea>
                    </div>
                    <div class="form-group">
    ...
    <div class="col-md-10 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="traitements/traitement-modif-produits.php" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo $_GET['id'];?>"/>
                    <input type="hidden" name="souscat" value="<?php echo $dataP['id_sous_categorie'];?>"/>
                    <div class="form-group">
