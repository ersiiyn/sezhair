...
if(isset($_POST['modif_produits'])){
    if(isset($_POST['id']) && !empty($_POST['id'])
        ...
        header('location:../public/admin.php?page=5&souscat_produits='.$idsouscat);
    }
}
elseif(isset($_POST['modif_photo'])){
    ...
    if($ext_up != 'jpg' && $ext_up != 'jpeg' && $ext_up != 'png' && $ext_up != 'bmp' && $ext_up != 'gif') {
        ...
        header('location:../public/admin.php?page=15&id='.$id);
    }
    else {
        $idsouscat = $_POST['souscat'];
        $imgDir = '../../public/assets/img/produits/';
        $filename = 'produits-'.time();
