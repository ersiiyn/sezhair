    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-4 mt-5">
                <div class="card">
                    <img src="../public/assets/img/produits/<?php echo $dataP['photo'];?>" class="card-img-top w-50 mx-auto" alt="...">
                    <div class="card-body mx-auto">
                        <h5 class="card-title"><?php echo $dataP['nom'];?></h5>
                        <p class="card-text"><?php echo $dataP['prix'];?> €</p>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#modal<?php echo $dataP['id']; ?>">
                        En savoir plus
                        </button>
                        <!-- Modal -->
                        <div class="modal fade" id="modal<?php echo $dataP['id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <img src="../public/assets/img/produits/<?php echo $dataP['photo'];?>" class="d-block w-100" alt="...">
                                            </div>
                                        </div>
